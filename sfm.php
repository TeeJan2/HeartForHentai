...
<body>
<div class="images">
    <img onclick="changeimg(this)" src="images/sfm/sfm1.png" alt="">
    <img onclick="changeimg(this)" src="images/sfm/sfm2.png" alt="">
    <img onclick="changeimg(this)" src="images/sfm/sfm3.png" alt="">
    <img onclick="changeimg(this)" src="images/sfm/sfm4.png" alt="">
</div>

<div class="pre">
    <a onclick="this.parentElement.style.display='none'" class="ion-close"></a>
    <img id="p" src="images/sfm/sfm1.png" alt="">
</div>
