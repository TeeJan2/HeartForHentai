...
<body>
<div class="images">
    <img onclick="changeimg(this)" src="images/overwatch/o1.png" alt="">
    <img onclick="changeimg(this)" src="images/overwatch/o2.png" alt="">
    <img onclick="changeimg(this)" src="images/overwatch/o3.png" alt="">
    <img onclick="changeimg(this)" src="images/overwatch/o4.png" alt="">
</div>

<div class="pre">
    <a onclick="this.parentElement.style.display='none'" class="ion-close"></a>
    <img id="p" src="images/overwatch/o1.png" alt="">
</div>
